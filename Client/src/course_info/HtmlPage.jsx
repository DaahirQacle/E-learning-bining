...
import HtmlCurriculum from "./HtmlCurriculum";
        ...
        <div className="col-8 my-4">
          ...
          <div className="shadow-lg  p-5 ">
            ...
            <div className="row my-4">
              <div className="col-6">
                ...
                <span>Web Page Designs </span>
              </div>
              <div className="col-6">
                <BsCheck2 className="text-success fs-3 " />
                <span>Modern Flex Box Css</span>
              </div>
            </div>
            <div className="row my-3">
              <div className="col-6">
                <BsCheck2 className="text-success fs-3 " />
                <span>Modern Grid Css</span>
              </div>
              <div className="col-6">
                <BsCheck2 className="text-success fs-3 " />
                <span>Html Five</span>
          ...
          <div className="my-4 shadow-lg">
            ...
            <p className="text-center ">
             We’re committed to changing the future of learning for 
             the better and provide the tools and skills to teach what you love.
            </p>
            <HtmlCurriculum />
          </div>
        </div>
